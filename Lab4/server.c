...
int  r, length, n, n2;                   // help variables
...
main(int argc, char *argv[])
{
   ...
   while(1){
     ...
     while(1){
       n = read(client_sock, num1, MAX);
       n2 = read(client_sock, num2, MAX);
       if (n==0 || n2==0){
      ...
      printf("server: read  n=%d bytes; num1 = (%lf), num2 = (%lf)\n", n + n2, num1, num2);

      // Add two given numbers
      ans = num1 + num2;

      // send the echo line to client 
      n = write(client_sock, ans, MAX);

      printf("server: wrote n=%d bytes; ans = (%lf)\n", n, ans);
